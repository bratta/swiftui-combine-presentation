...
// ---
// You can quickly turn your own JSON feed into models usable in Swift by visiting:
// https://app.quicktype.io/
// ---

import Foundation

// NOTE: Don't remove this if you are updating the model by copying+pasting from QuickType.
